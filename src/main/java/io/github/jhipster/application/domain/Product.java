 ...
 */
@ApiModel(description = "This is a microservice e-commerce store sample with Gateway and two microservice applications This uses JHipster registry for service discovery /** Product sold by the Online store")
@Entity
@Table(name = "product")
