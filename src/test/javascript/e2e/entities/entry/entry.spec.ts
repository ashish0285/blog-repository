...
describe('Entry e2e test', () => {
    ...
    it('should load Entries', async () => {
        ...
        expect(await entryComponentsPage.getTitle()).to.eq('myBlogApp.entry.home.title');
    });

    it('should load create Entry page', async () => {
        await entryComponentsPage.clickOnCreateButton();
        entryUpdatePage = new EntryUpdatePage();
        expect(await entryUpdatePage.getPageTitle()).to.eq('myBlogApp.entry.home.createOrEditLabel');
    ...
    it('should delete last Entry', async () => {
        ...
        expect(await entryDeleteDialog.getDialogTitle()).to.eq('myBlogApp.entry.delete.question');
