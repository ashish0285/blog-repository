...
describe('ProductOrder e2e test', () => {
    ...
    it('should load ProductOrders', async () => {
        ...
        expect(await productOrderComponentsPage.getTitle()).to.eq('myBlogApp.productOrder.home.title');
    });
    ...
    it('should load create ProductOrder page', async () => {
        ...
        expect(await productOrderUpdatePage.getPageTitle()).to.eq('myBlogApp.productOrder.home.createOrEditLabel');
    ...
    /* it('should delete last ProductOrder', async () => {
        ...
        expect(await productOrderDeleteDialog.getDialogTitle())
            .to.eq('myBlogApp.productOrder.delete.question');
