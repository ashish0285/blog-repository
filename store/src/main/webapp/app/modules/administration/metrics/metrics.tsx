                    ...
                    <Col md="4">
                        ...
                        >
                            <span>
                                <TextFormat
                                    value={
                                        (metrics.gauges['jvm.memory.heap.used'].value * 100) / metrics.gauges['jvm.memory.heap.max'].value
                                    }
                                    type="number"
                                    format={APP_WHOLE_NUMBER_FORMAT}
                                />
                                        ...
                                        <td className="text-right">
                                            <TextFormat
                                                value={this.filterNaN(
                                                    metrics.meters['com.codahale.metrics.servlet.InstrumentedFilter.responseCodes.ok']
                                                        .mean_rate
                                                )}
                                                type="number"
                                    ...
                                    <tr key={1}>
                                        ...
                                        <td>
                                            <Progress
                                                ...
                                                max={metrics.timers['com.codahale.metrics.servlet.InstrumentedFilter.requests'].count}
                                                value={
                                                    metrics.meters['com.codahale.metrics.servlet.InstrumentedFilter.responseCodes.notFound']
                                                        .count
                                                }
                                                color="success"
                                                animated
